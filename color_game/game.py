...
from hardware import Color, RGB, big_red_button_pressed, buttons, buttons_in_order
...
class ColorMixerState:
    ...
    def next_state(self, input: Input) -> State | None:
        if big_red_button_pressed():
            return None  # back to the menu -- color_game has no win/lose state of its own
